...
namespace Solo.Scripts.System.ItemSystem
{
    public class ItemDataManager
    {
        ...
        private ItemDataManager()
        {
            ...
            _itemDataMap.Add(ItemType.WoodRod, new ItemData { Name = "木竿", IconPath = "res://Assets/AtlasTextures/WoodRod.tres", MaxDur = 100 });
            _itemDataMap.Add(ItemType.WoodHelmet, new ItemData { Name = "木盔", IconPath = "res://Assets/AtlasTextures/WoodHelmet.tres", MaxDur = 100, IsArmor = true, ArmorSlot = ArmorSlotType.Helmet });
            _itemDataMap.Add(ItemType.WoodArmor, new ItemData { Name = "木甲", IconPath = "res://Assets/AtlasTextures/WoodArmor.tres", MaxDur = 100, IsArmor = true, ArmorSlot = ArmorSlotType.Armor });
            _itemDataMap.Add(ItemType.WoodBoot, new ItemData { Name = "木鞋", IconPath = "res://Assets/AtlasTextures/WoodBoot.tres", MaxDur = 100, IsArmor = true, ArmorSlot = ArmorSlotType.Boot });
            ...
            _itemDataMap.Add(ItemType.IronRod, new ItemData { Name = "铁竿", IconPath = "res://Assets/AtlasTextures/IronRod.tres", MaxDur = 100 });
            _itemDataMap.Add(ItemType.IronHelmet, new ItemData { Name = "铁盔", IconPath = "res://Assets/AtlasTextures/IronHelmet.tres", MaxDur = 100, IsArmor = true, ArmorSlot = ArmorSlotType.Helmet });
            _itemDataMap.Add(ItemType.IronArmor, new ItemData { Name = "铁甲", IconPath = "res://Assets/AtlasTextures/IronArmor.tres", MaxDur = 100, IsArmor = true, ArmorSlot = ArmorSlotType.Armor });
            _itemDataMap.Add(ItemType.IronBoot, new ItemData { Name = "铁鞋", IconPath = "res://Assets/AtlasTextures/IronBoot.tres", MaxDur = 100, IsArmor = true, ArmorSlot = ArmorSlotType.Boot });
            ...
            _itemDataMap.Add(ItemType.GoldRod, new ItemData { Name = "金竿", IconPath = "res://Assets/AtlasTextures/GoldRod.tres", MaxDur = 100 });
            _itemDataMap.Add(ItemType.GoldHelmet, new ItemData { Name = "金盔", IconPath = "res://Assets/AtlasTextures/GoldHelmet.tres", MaxDur = 100, IsArmor = true, ArmorSlot = ArmorSlotType.Helmet });
            _itemDataMap.Add(ItemType.GoldArmor, new ItemData { Name = "金甲", IconPath = "res://Assets/AtlasTextures/GoldArmor.tres", MaxDur = 100, IsArmor = true, ArmorSlot = ArmorSlotType.Armor });
            _itemDataMap.Add(ItemType.GoldBoot, new ItemData { Name = "金鞋", IconPath = "res://Assets/AtlasTextures/GoldBoot.tres", MaxDur = 100, IsArmor = true, ArmorSlot = ArmorSlotType.Boot });
            ...
            _itemDataMap.Add(ItemType.JadeRod, new ItemData { Name = "玉竿", IconPath = "res://Assets/AtlasTextures/JadeRod.tres", MaxDur = 100 });
            _itemDataMap.Add(ItemType.JadeHelmet, new ItemData { Name = "玉盔", IconPath = "res://Assets/AtlasTextures/JadeHelmet.tres", MaxDur = 100, IsArmor = true, ArmorSlot = ArmorSlotType.Helmet });
            _itemDataMap.Add(ItemType.JadeArmor, new ItemData { Name = "玉甲", IconPath = "res://Assets/AtlasTextures/JadeArmor.tres", MaxDur = 100, IsArmor = true, ArmorSlot = ArmorSlotType.Armor });
            _itemDataMap.Add(ItemType.JadeBoot, new ItemData { Name = "玉鞋", IconPath = "res://Assets/AtlasTextures/JadeBoot.tres", MaxDur = 100, IsArmor = true, ArmorSlot = ArmorSlotType.Boot });
