...
namespace Solo.Scripts.System.BuildingSystem
{
    public class BuildingDataManager
    {
        ...
        private BuildingDataManager()
        {
            ...
            _buildingDataMap.Add(BuildingType.Stone, new BuildingData() { Width = 2, Height = 2, TextureHeight = 3, TexturePath = "res://Assets/AtlasTextures/Stone.tres", MaxHp = 100, DropItemList = new List<(ItemType, int, int)>() { (ItemType.Stone, 1, 3), } });
