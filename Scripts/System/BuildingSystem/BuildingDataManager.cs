...
namespace Solo.Scripts.System.BuildingSystem
{
    public class BuildingDataManager
    {
        ...
        private BuildingDataManager()
        {
            ...
            _BuildingDataMap.Add(BuildingType.Stone, new BuildingData() { Type = BuildingType.Tree, Width = 2, Height = 2 });
            _BuildingDataMap.Add(BuildingType.Core, new BuildingData() { Type = BuildingType.Tree, Width = 4, Height = 4 });
            ////材料
