    ...
    public class UnitDataManager
    {
        ...
        private UnitDataManager()
        {
            _unitDataMap.Add(UnitType.Wolf, new UnitData()
            {
                ...
                PatrolDuration = 2,
                PatrolRadius = 200,
                ViewCollisionShapeRadius = 64,
                AtkRange = 32,
                CdDuration = 1f,
                Size = 2,
                AtkTargetTypeList = new List<TargetType>() { TargetType.Player, TargetType.Fox },
            ...
            _unitDataMap.Add(UnitType.Fox, new UnitData()
            {
                ...
                CdDuration = 0.3f,
                Size = 1,
                AtkTargetTypeList = new List<TargetType>() { TargetType.Player, TargetType.Tree },
                FearTargetTypeList = new List<TargetType>() { TargetType.Wolf },
                DropItemList = new List<(ItemType, int, int)>() { (ItemType.Stone, 1, 3), }
            });
        }
